...
Aun cuando el diseño del Índice describe seis niveles de competitividad, un análisis de los patrones de desempeño general de los 32 estados revela una división clara del país en dos grandes bloques, aquellos estados que concentran mejores condiciones de competitividad (competitividad alta) y las entidades que enfrentan dificultades generalizadas para la competitividad (competitividad baja).
...
lay <- 
  create_layout(
    ...
    # niter = 2000,                          # más iteraciones
    # area  = vcount(net_tbl)^2 * 1.2,       # espacio proporcional
    # repulserad  = vcount(net_tbl)^2 * 3          # radio de repulsión
  )
